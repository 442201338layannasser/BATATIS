...
class RBNewOrders extends StatefulWidget {
  const RBNewOrders({super.key});

  @override
  State<RBNewOrders> createState() => _RBNewOrdersState();
}

List<dynamic> itemsofmember2 = [];
List<dynamic> itemsofmember = [];

class _RBNewOrdersState extends State<RBNewOrders>
...
//List<String>
  ...
  void fillOrders() {
    listOforders.forEach((element) async{
      var order = await Orders.getOrder(element.id);
      orderss.add(order);
      print("orders length ${orderss.length}");
