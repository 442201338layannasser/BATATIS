              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    !hasPassedFourHours(element.get("OrderTime")) ? 
                    CustomText(
                                ...
                                onPressed: () {
                                  showDialog<String>(
                                    ...
                                    builder: (BuildContext context) =>
                                      ...
                                      content: const Text(
                                          'The order is ready ,send it to the driver now'),
                                      actions: <Widget>[
                                        TextButton(
                                          //cancel
...
bool hasPassedFourHours(String OrderTime) {
   //String timestampString = '2023-11-23 01:15:22.123456';
  DateTime originalTime = DateTime.parse(OrderTime);

  DateTime now = DateTime.now();
  Duration difference = now.difference(originalTime);
  print("hasPassedFourHours ${difference.inHours >= 4}");
